...
//
//        response1 = orderController.createOrder(new Order(1, user, LocalDateTime.now(), CurrencyPair.BTCUSD, OrderType.SELL, 0.0, OrderStatus.OPEN, 9.0, 100.00,new ArrayList<Trade>())).getBody();
//        response2 = orderController.createOrder(new Order(2, user, LocalDateTime.now(), CurrencyPair.BTCUSD, OrderType.SELL, 0.0, OrderStatus.OPEN, 10.0, 50.00,new ArrayList<Trade>())).getBody();
//        response3 = orderController.createOrder(new Order(3, user, LocalDateTime.now(), CurrencyPair.BTCUSD, OrderType.BUY, 0.0, OrderStatus.OPEN, 7.0, 250.00,new ArrayList<Trade>())).getBody();
//        response4 = orderController.createOrder(new Order(4, user, LocalDateTime.now(), CurrencyPair.BTCUSD, OrderType.BUY, 0.0, OrderStatus.OPEN, 6.0, 800.00,new ArrayList<Trade>())).getBody();
...
//                HttpMethod.POST,
//                new HttpEntity<>(new Order(5, user, LocalDateTime.now(), CurrencyPair.BTCUSD, OrderType.BUY, 0.0, OrderStatus.OPEN, 9.0, 50.00,new ArrayList<Trade>())),
//                ResponseOrder.class
//        ).getBody();
